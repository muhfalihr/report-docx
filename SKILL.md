---
name: report-docx
description: "Create professional .docx reports from one of four structured templates: Indonesian academic paper/makalah (BAB I-V: Pendahuluan, Tinjauan Pustaka, Metodologi, Hasil dan Analisis, Kesimpulan dan Saran — A4, Times New Roman 12, spasi 1.5, margin kiri 4cm/lainnya 3cm), college/coursework report, work report, or general report. MUST be used whenever the user asks for a report in Word/.docx format — including 'makalah', 'laporan', 'tugas kuliah', 'skripsi', 'lab report', 'assignment report', 'coursework report', 'work report', 'internship report', 'project report', 'activity report', 'make a report', 'generate report', 'report docx', or names one of the templates above. This skill MUST collect the report's content/details from the user through a structured interview before building the document, and MUST NOT fill in dummy/fabricated data. Do not use for PDF, spreadsheets, or reports not requested as a Word file."
license: Proprietary
---
